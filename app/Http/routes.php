...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::group(['namespace'=>'Admin','prefix'=>'admin','middleware' => ['auth','admin']],function(){
        ...
        //admin_note
        Route::get('note','NoteController@viewadminNote');
        ...
        Route::get('team_management/employee/{id}','TeamManagementController@viewEmployee');
         //client feedback
        ...
        // Notifiaction
        Route::post('/', 'RequestController@postNotify');
