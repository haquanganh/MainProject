...
<body>
    <div class="containfer-fluid">
                ...
                <ul>
                    ...
                    <li class="aditional additionalmanagement">
                        <ul class="nav nav-stacked" id="add-menu">
                            ...
                            <li class="addnewskill"><a href="{{ url('/admin/add-skill') }}"><span><i class="fa fa-globe" aria-hidden="true"></i></span>Develop skill</a></li>
        ...
        <div id="maincontent">
            <div id="topbar">
                <h4 id="page-name" style="float: left">@yield('sub-title')</h4>
                <ul id="action">
                    <li><a href="{{ url('/admin/personal-information') }}"><i class="glyphicon glyphicon-home"></i></a></li>

                    <!-- Messsage -->
                    <?php
                        $result = App\Message::where('M_Status', '=', '0')->get();
                        $count = count($result);
                    ?>
                    <li>
