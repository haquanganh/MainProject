...
@section('content')
    ...
    <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th>Content</th>
                <th width="130px">Send time</th>
                <th width="130px">Response time</th>
                <th >Action</th>
            </tr>
        </thead>
        <tbody>
        @foreach ($list_requestC_E as $listrequest)
            <tr>
                ...
                <td>{{ Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $listrequest->dateCreate)->format('d-F-Y H:i:s') }}</td>
                @if ($listrequest->responseTime == null)
                    <td></td>
                @else
                    <td>{{ Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $listrequest->responseTime)->format('d-F-Y H:i:s') }}</td>
                @endif
                <td>
