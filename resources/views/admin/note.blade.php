...
.content-box-large {
    ...
    background-size: 50px 40px ,187px 165px;
    ...
    margin-left: 40px;
    margin-right: 0px;/* 
    -webkit-box-shadow: 5px 5px 5px 0px rgba(107, 7, 32, 1);
    -moz-box-shadow: 5px 5px 5px 0px rgba(107, 7, 32, 1);
    box-shadow: 10px 10px 5px 0px rgba(107, 7, 32, 1); */
}
            ...
            <div class="modal fade" id="view-id{{ $idnote->idNote }}">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="{{ url('/view-note') }}" method="POST" accept-charset="utf-8" id="form-edit">
                        {{csrf_field()}}
