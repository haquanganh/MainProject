    ...
    <div class="row feature1">
        <div class="col-md-5">
            ...
            <div class="panel panel-info history_feedback panel-group">
                ...
                @if ($feedbacks->count() != 0)
                    ...
                    @endforeach
                @else
                <i>{{ App\Employee::where('idAccount','=',$employee->idAccount)->first()->E_EngName }}</i> hasn't had any feedback from Clients
                @endif
                </div>
            </div>
        </div>
        <div class="col-md-7 personal-info">
                <div class="panel panel-info">
                    <div class="panel-heading">Personal Information <a href="{{ route('admin.personal-information.edit',$employee->idEmployee) }}" class="pull-right"><span class="glyphicon glyphicon-pencil "></span></a></div>
                    <div class="panel-body">
                        <div class="row">
