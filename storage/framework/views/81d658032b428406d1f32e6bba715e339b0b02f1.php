...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/project_detail.css')); ?>">
<link href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.2/css/select2.min.css" rel="stylesheet" />
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
            <div id="img-title">
                <p>Project Information
                    <a href="<?php echo e(url('/project/edit/')); ?>/<?php echo e($project->idProject); ?>" class="pull-right" style="color:white;"><i class="glyphicon glyphicon-edit"></i></a>
                </p>
            </div>
            <?php
            ...
            <div class="row">
                <div class="col-md-6 text-center" style="height:500px;marign:0px;background-color:#EDEDED;color:black;padding-top:20px;">
                    <div>
                        <h4><b><?php echo e($client->ClientName); ?></b></h4>
                        <h1><b><?php echo e($project->P_Name); ?></b></h1>
                        <h4><i><?php echo e($project->P_DateStart); ?> <span>-</span><?php echo e($project->P_DateFinish); ?></i></h4>
                        <h4><?php echo e($PM->E_EngName); ?></h4>
                        <h3><?php echo e($project->P_Note); ?></h3>
                    </div>
                </div>
                <div class="col-md-6" style="height:500px;background-color:#FFFFFF; margin:0px;">
                    <div class="team" style="margin-top:15px">
                        <div class="row text-center">
                            <a class="link" data="<?php echo e($teamLeader->idEmployee); ?>" href="#" ><img class="img img-circle" src="<?php echo e(asset('images/personal_images')); ?>/<?php echo e($teamLeader->E_Avatar); ?>" style="width:80px;height:80px" alt=""></a>
                            <p><?php echo e($teamLeader->E_EngName); ?></p>
                        </div>
                        <div class="row text-center">
                            <?php foreach($project->Employee as $e): ?>
                            <?php if(count($project->Employee) == 3 ): ?>
                                <div class="col-md-4">
                                    <a class="link" data="<?php echo e($e->idEmployee); ?>" href="#"><img class="img img-circle" src="<?php echo e(asset('images/personal_images')); ?>/<?php echo e($e->E_Avatar); ?>" style="width:50px;height:50px" alt=""></a>
                                    <p style="word-wrap: break-word;"><?php echo e($e->E_EngName); ?></p>
                                </div>
                            <?php elseif(count($project->Employee) ==2 ): ?>
                            <div class="col-md-6">
                                    <a class="link" data="<?php echo e($e->idEmployee); ?>" href="#"><img class="img img-circle" src="<?php echo e(asset('images/personal_images')); ?>/<?php echo e($e->E_Avatar); ?>" style="width:50px;height:50px" alt=""></a>
                                    <p style="word-wrap: break-word;"><?php echo e($e->E_EngName); ?></p>
                            </div>
                            <?php elseif(count($project->Employee) ==1): ?>
                                <div class="col-md-12">
                                    <a class="link" data="<?php echo e($e->idEmployee); ?>" href="#"><img class="img img-circle" src="<?php echo e(asset('images/personal_images')); ?>/<?php echo e($e->E_Avatar); ?>" style="width:50px;height:50px" alt=""></a>
                                    <p style="word-wrap: break-word;"><?php echo e($e->E_EngName); ?></p>
                            </div>
                                    ...
                                    <ul class="list-group tech-info">
                                        ...
                                        <ul class="list-group feedback">
                                            ...
                                            <li class="list-group-item edit-form">
                                                <form class="edit-feedback" method="POST" action="<?php echo e(url('/')); ?>">
                                                <?php echo csrf_field(); ?>
    ...
    <!-- Feedback form-->
    <form id="form-feedback" method="POST" action="<?php echo e(url('/client-feedback')); ?>">
    <?php echo csrf_field(); ?>
       ...
       <div class="modal fade" id="feedback-form" >
        ...
        <?php endif; ?>
        <!-- <li class="list-group-item edit-form">
            <form class="edit-feedback" method="POST" action="<?php echo e(url('/client-edit-feedback')); ?>"><?php echo csrf_field(); ?>

                <textarea class="form-control" name="edit-text">'+ val.F_Content +'</textarea>
                <textarea name="edit-text-backup" style="display:none;">'+ val.F_Content +'</textarea>
                <input type="hidden" name="F_Title" value="'+ val.F_Title +'"></input>
                <input type="hidden" name="F_Rate" value="'+ val.F_Rate +'"></input>
                <input type="hidden" name="getIdfeedback" value="'+ val.idFeedback+'"></input>
                <div class="pull-right">
                    <input type="submit" class="btn btn-primary" value="Save"></input>
                    <input type="button" class="btn btn-default hide-edit" value="Cancel"></input>
                </div>
